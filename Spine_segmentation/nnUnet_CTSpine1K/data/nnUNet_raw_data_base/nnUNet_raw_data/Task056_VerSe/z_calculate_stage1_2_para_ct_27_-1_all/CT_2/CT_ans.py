...
ct_r =  "./CT_patient_result_cancellous_seg"
ct_r_list = ["CT_patient_result_cancellous_seg","CT_patient_result_cancellous_gth","CT_patient_result_cancellous_s"]
ct_benchmark_r = "./CT_benchmark_result_cancellous"
json_out = "./result_cancellous_with_mean_3"
if not os.path.exists(json_out):
    os.makedirs(json_out)

excel_path = "result_cancellous_with_mean_3.xlsx"
sheet_str = "Spine"

info = ["file_name","seg_density","seg_mean","seg_class","gth_density","gth_mean","gth_class","s_density","s_mean","s_class"]
...
for file in tqdm(os.listdir(ct_r)):
    if(file.split(".")[-1]=="json" and file.split(".")[-2][-3:]=="_py"):
        ...
        cbmd_dict = {}
        for id,ct_r_cur in enumerate(ct_r_list):

            cur = ct_r_cur.split("_")[-1]
            file_t = os.path.join(ct_r_cur,"predict_{}_{}_py.json".format(Gn,PAn))
            PA1_filename = file_t
            ...
            # all_intensity_patient =      lv_dict  
            mean_density_patient = lv_dict
            ...
            cbmd_dict["{}_density".format(cur)] = mean_density_patient
            cbmd_dict["{}_mean".format(cur)] = mean_cBMD
            cbmd_dict["{}_class".format(cur)] = check_class(mean_cBMD)
